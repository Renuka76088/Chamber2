...
const TenderContractPage = () => {
  ...
  const h3Style = "text-[18px] font-black uppercase  text-[#d97706] mb-3 flex items-center gap-2";
  ...
  return (
    <div className="bg-white font-sans text-gray-900 pb-10">
      ...
      <section className="relative h-[300px] bg-gray-900 text-white flex items-center overflow-hidden border-b-4 border-[#d97706]">
        <div className="absolute inset-0 opacity-40">
          <img 
            src="https://images.unsplash.com/photo-1579227114347-15d08fc37cae?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80" 
            alt="Textile" 
            className="w-full h-full object-cover grayscale"
          />
        </div>
        <div className="absolute right-0 top-0 bottom-0 w-1/4 bg-[#d97706] transform translate-x-20 -skew-x-12 opacity-90"></div>
        
        <div className="max-w-6xl mx-auto px-6 relative z-10 w-full">
          <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-3">
            Expression of <span className="text-[#d97706]">Interest</span>
          </h1>
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-10 border-b border-gray-100 pb-8">
          ...
          <div className="grid grid-cols-2 gap-4 bg-gray-50 p-5 border-l-4 border-gray-900">
             ...
             <div>
                ...
                <p className="text-[18px] font-bold text-[#d97706]">01 Year</p>
             </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 text-white p-8 mb-10 grid md:grid-cols-2 gap-8">
           <div className="flex gap-4">
              <Truck className="text-[#d97706] shrink-0" size={24} />
              <div>
           ...
           <div className="flex gap-4 border-l border-gray-700 pl-8">
              <CreditCard className="text-[#d97706] shrink-0" size={24} />
              <div>
        ...
        <div className="grid md:grid-cols-4 gap-4 border-t border-gray-100 pt-8 mb-10">
           {[
             ...
             <div key={i} className="bg-gray-50 p-4 border-b-2 border-transparent hover:border-[#d97706] transition-all">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 border-2 border-gray-900 p-6">
           <div className="flex gap-4 items-center">
              <Info className="text-[#d97706]" size={28} />
              <p className="text-[17px] font-medium">Tender Documents available <b>In-Person</b> (Prescribed Fee).</p>
           </div>
           <button className="bg-[#d97706] text-white px-8 py-4 font-black text-xs uppercase tracking-widest hover:bg-black transition-all flex items-center gap-3">
